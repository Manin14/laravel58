                    ...
                    <form method="POST" action="{{ url('siswa') }}/{{ $siswa->id}}">
                       ...
                       <input type="hidden" name="_method" value="PUT">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nim" type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ $siswa->nim }}" required autocomplete="current-nim">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ $siswa->tanggal }}" required autocomplete="current-tanggal">
